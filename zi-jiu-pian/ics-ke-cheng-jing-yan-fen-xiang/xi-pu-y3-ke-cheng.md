...
Assessments: 总的来说，这门课高分不算特别困难，毕竟我们这一届都有满分。但代码部分如果平常没有好好练的话，限时考试的时候会很拖节奏，最后导致写不完试题。虽然平时的代码题基本上就是送分，但也一定要自己写一下，别直接抄。因为后面 Final Project 和 Final Exam 里面都有限时代码题，和平常的代码作业强相关，对日常作业理解透能节省很多时间。如果觉得平常作业比较困难，可以额外刷刷力扣简单题。
